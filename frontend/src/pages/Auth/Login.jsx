...
const Login = () => {
  ...
  const handleOAuthLogin = (provider) => {
    navigate("http://localhost:5000/api/auth/" + provider); // Redirect to OAuth route
        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl overflow-hidden border border-gray-100 hover:shadow-xl sm:hover:shadow-2xl transition-all duration-300">
          ...
          <div className="p-6 sm:p-8">
            <form onSubmit={handleSubmit}>
              ...
              <div className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className={`group relative w-full py-2.5 px-4 rounded-lg font-medium text-sm shadow-md transform transition-all duration-300 ${
                    isLoading
            ...
            <div className="mt-3 text-center">
              <button onClick={() => navigate('/auth/forgot-password')} className="text-indigo-600 hover:text-purple-600 font-medium transition-colors duration-300 text-xs sm:text-sm">
                Forgot Password?
              </button>
            </div>
            ...
            <div className="mt-4 text-center">
              <p className="text-gray-600 text-xs sm:text-sm">
                ...
                <button onClick={()=>navigate('/auth/register')} className="text-indigo-600 hover:text-purple-600 font-medium cursor-pointer relative group transition-colors duration-300">
                  Create Account
